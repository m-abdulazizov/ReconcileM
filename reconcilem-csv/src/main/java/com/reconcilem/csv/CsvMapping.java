...
public final class CsvMapping {
    ...
    private CsvMapping(Builder builder) {
        ...
        this.dateFormatter = builder.dateFormatter == null
                ? DateTimeFormatter.ISO_LOCAL_DATE
                : builder.dateFormatter;
    ...
    public static final class Builder {
        ...
        public Builder dateFormatter(DateTimeFormatter dateFormatter) {
